# ShopIn Coding Standards & Best Practices

**Version:** 1.0.0
**Last Updated:** 2025-12-31
**Architecture:** Next.js (App Router) + React + Supabase Auth + Tailwind CSS; backend: NestJS + Prisma (Postgres)
...
| **Package Manager** | `npm` | pnpm, bun, npm, yarn, pip, poetry, cargo, go mod |
| **Backend Framework** | `NestJS` | Hono, Elysia, Express, Fastify, FastAPI, Gin, Axum |
| **Frontend Framework** | `Next.js (React)` | React, Vue, Svelte, Solid, None |
| **Database/ORM** | `Prisma` | Drizzle, Prisma, SQLAlchemy, GORM, Diesel |
| **Testing Framework** | `Jest / Vitest` | Vitest, Jest, pytest, go test, cargo test |
| **Linter/Formatter** | `ESLint + Prettier` | Biome, ESLint + Prettier, Ruff, golangci-lint, rustfmt |
